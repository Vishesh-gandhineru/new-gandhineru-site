  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage : {
        ...
        'hero-about-mob-banner' : "url('/Images/about-cover-mob.png')",
        'MegaMenu-bg' : "url('/Images/MegaMenuBg.png')",
        'footer-bg' : "url('/Images/footerBg.png')",
        'hero-blog-banner' : "url('/Images/Blog cover.png')",
        'hero-contact-banner' : "url('/Images/contact-bg-cover.png')",
        'hero-contact-mob-banner' : "url('/Images/contact-bg-cover-mob.png')",
        'relume-logo' : "url('/Images/compony logo.png')",
        'hero-server-banner' : "url('/Images/service-hero-banner.png')",
        'hero-server-mob-banner' : "url('/Images/service-cover-mob.png')",
        ...
        "blog-cover-mobile" : "url('/Images/blog-cover-mobile.png')",
      },

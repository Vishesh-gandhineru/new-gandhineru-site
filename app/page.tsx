...
import {
  ...
  FadeInDiv,
  FadeInSection,
} from "@/components/CustomUi/MotionDiv";
...
const page = async () => {
  return (
    <main>
      ...
      >
        <HeroImageCarousel />
        <FadeInDiv className="w-full h-full pt-[90px] md:pt-[50px] pb-[50px] justify-between md:justify-end lg:justify-center md:w-[80%] lg:w-[60%] flex flex-col gap-[80px]">
          <div className="flex flex-col gap-3 lg:gap-8">
            <h1 className="normal-case">
              Simply put, we design and build brands
            </h1>
            <p className=" text-base lg:text-2xl">
              Driven by visuals, tech and automation
            </p>
          </div>
      ...
      <FadeInSection className=" py-16 w-full xl:max-w-[1300px] mx-auto my-[20px] flex flex-col gap-[80px]">
        <AnimatedLogoBanner />
      </FadeInSection>
      <FadeInSection className="sectionContainer w-full md:max-w-[1000px]">
        <Work />
      </FadeInSection>
      <FadeInSection className="sectionContainer flex flex-col lg:flex-row gap-5 md-flex-row justify-between items-start lg:items-end space-y-8">
        <Heading

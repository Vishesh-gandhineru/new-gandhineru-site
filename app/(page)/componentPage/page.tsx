...
const page = () => {
  ...
  // useEffect(() => {
  //   const SliderAnimation = async () => {
  //     await animate("#video1", { opacity: 1}, { duration: 5 });
  //     await animate("#video1", { opacity: 0 }, { duration: 5 });
  //     await animate("#video2", { opacity: 1}, { duration: 5 });
  //     await animate("#video2", { opacity: 0}, { duration: 5 });
  //     await animate("#video3", { opacity: 1}, { duration: 5});
  //     await animate("#video3", { opacity: 0}, { duration: 5});
...
//       >
//         {/* <MotionDiv id="video1" className="w-full h-full absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[10]">
...
//           className="h-full w-full object-cover  object-right z-[10] rounded-[20px]" autoPlay loop muted></video>

//         </MotionDiv> */}
//         <MotionDiv id="video2" className="w-full h-full absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[5]">
//           <video src="https://cms.gandhineru.com/wp-content/uploads/2024/07/a_tap_on_the_wall_flowing_popcorns_out_and_that_popcorns_in_getting_collected_into_the_blow__and_the_dd4b05.mp4" 
//           className="h-full w-full object-cover  object-right z-[5] rounded-[20px]" autoPlay loop muted></video>

//         </MotionDiv>
//         {/* <MotionDiv id="video3" className="w-full h-full absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[1]">
//           <video src="https://cms.gandhineru.com/wp-content/uploads/2024/07/noodles_flowing_out_from_catel_mouth___falling_into_blow_and_its_overflowing_from_blow_6be57f.mp4" 
//           className="h-full w-full object-cover  object-right z-[1] rounded-[20px]" autoPlay loop muted></video>
//         </MotionDiv> */}

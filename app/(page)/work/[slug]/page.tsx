    ...
    <main>
      ...
      <section className="sectionContainer !pt-0 flex flex-col lg:flex-row flex-wrap gap-8 items-center justify-between ">
        ...
        <MotionDiv
          ...
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8, ease: "easeInOut" }}
          className="w-full lg:w-[40%] flex flex-wrap  h-fit gap-x-5 gap-y-8"
        >
            ...
            <div className="flex flex-row gap-4 flex-wrap">
              {_embedded["wp:term"][0].map((service: any, index: number) => {
                return (
                  <span
                    key={index}
                    className=" w-fit inline-block border-[1px] rounded-full px-5 py-3 border-[#D0D0D0] uppercase text-[12px] leading-3 tracking-wider font-normal"
                  >
      ...
      <section className="sectionContainer grid grid-cols-1 gap-14 lg:grid-cols-2 justify-center items-center">
        <MotionDiv
          ...
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8, ease: "easeInOut" }}
          className="text-center w-full lg:w-[80%]"
        >
        ...
        <MotionDiv
          ...
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8, ease: "easeInOut" }}
          className="relative h-[300px] lg:h-[560px] w-full"
        >
          <Image
            src={bold_text_image}
            fill
      ...
      <section className="sectionContainer flex flex-row flex-wrap gap-8 items-center justify-between">
        <MotionDiv
          ...
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8, ease: "easeInOut" }}
          className="WorkContent w-full md:w-[45%]"
        >
      ...
      <section className="max-w-[1400px] m-auto grid grid-cols-1 md:grid-cols-2 gap-[80px] my-[50px] justify-center items-center">
        ...
        >
          ...
          />
          <p className="text-[#686462] mt-8 text-sm">
            {client_testimonial_name}
          </p>
        </MotionDiv>
      </section>
